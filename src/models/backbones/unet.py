# The code has been adapted from https://github.com/microsoft/TRELLIS/blob/main/trellis/models/sparse_structure_vae.py
...
from src.modules.spatial import pixel_shuffle_3d
from src.modules.utils import convert_module_to_f16, convert_module_to_f32, zero_module
...
class ResBlock3d(nn.Module):
    def __init__(
        ...
        norm_type: Literal["group", "layer", "batch"] = "batch",
    ):
        super().__init__()
