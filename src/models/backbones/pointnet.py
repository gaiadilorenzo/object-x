# The code has been adapted from https://github.com/y9miao/VLSG/blob/main/src/models/sgaligner/src/aligner/networks/pointnet.py
...
from src.models.backbones.base import BaseNetwork
...
class PointNetCls(BaseNetwork):
    def __init__(
        self, k=2, in_size=1024, batch_norm=True, drop_out=True, init_weights=True
    ):
